...
var MongoData = (function() { 'use strict';
	...
	var displayRecord = function(index) {
		$(".dataDisplay").css("background-image","none");  // Clear out the background image so text can display.
		$(".dataDisplay").css("border", "solid gray 2px"); // Changes the border properties.
		$(".dataDisplay").css("width", "300px");
		$(".dataDisplay").css("height", "420px");
